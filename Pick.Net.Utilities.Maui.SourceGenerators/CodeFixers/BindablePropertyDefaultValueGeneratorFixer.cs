...
public sealed class BindablePropertyDefaultValueGeneratorFixer() : BaseCodeFixProvider<MemberDeclarationSyntax>("Add default value generator", DiagnosticDescriptors.BindablePropertyNoDefaultValue)
{
